...
public class Ex17 {
    ...
    public static void main(String[] args) {
         ...
         * Faça com que o programe informe que a data é inválida assim que o usuário
         * informar um valor inexistente.
         * Por exemplo, assim que o usuário informar o dia 50 o programa já deve parar e
         * não deve receber o mês e ano.
         */
            ...
            if (mes >= 1 && mes <= 12) {
                ...
                if (mes == 2) {
                    ...
                    if ((ano % 4 == 0) && (ano % 100 == 0) ||
                        ...
                        System.out.println(
                                "Dia inválido, no mês de fevereiro o dia não pode ser maior que 28");
